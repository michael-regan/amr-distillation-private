...
def generate_amr_lines(f1, f2):
    ...
    while True:
        ...
        if not cur_amr1 and not cur_amr2:
            ...
            for cur1, cur2 in zip(cur_amr1, cur_amr2):
                yield cur1, cur2
                continue
        break
...
#         veryVerbose = True
    ...
    for (precision, recall, best_f_score) in score_amr_pairs(f1, f2):
...
#                                                              justrelation=arguments.justrelation):
    ...
    #score_obj =  {"precision": floatdisplay % precision, "recall": floatdisplay % recall, "f1": floatdisplay % best_f_score}
    score_obj =  {"precision": precision, "recall": recall, "f1": best_f_score}
